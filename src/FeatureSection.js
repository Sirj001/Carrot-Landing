  ...
  return (
    <section className="grid grid-cols-3 sec-1 gap-6 p-10">
      ...
      <div className="text-black p-4">
        <img className="img" src="./images/shape.jpg.jpeg" alt=""></img>
      ...
      <div className="text-black p-4">
        <img className="img" src="./images/home.jpg.jpeg" alt=""></img>
      ...
      <div className="text-black p-4">
        <img className="img" src="./images/double.jpg.jpeg" alt=""></img>
      ...
      <div className="text-black p-4">
        <img className="img" src="./images/hot.jpg.jpeg" alt=""></img>
